...
private UpgradeRepository upgradeRepository;
    ...
    public void addUnit(Long armyId, SelectedUnitDTO selectedUnitDTO) {
        ...
        if (selectedUnitDTO.getUnit() == null || selectedUnitDTO.getUnit().getId() == null) {
        ...
        if ( selectedUnit.getSelectedUpgrades() == null) {
            selectedUnit.setSelectedUpgrades(new ArrayList<>());
        }
